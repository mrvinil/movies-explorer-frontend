...
// функция проверки изображений полученных от сервера
...
// функция преобразования длительности
...
// функция сравнения сохраненных фильмов
...
export { transformMovies, filterMovies, filterShortMovies, transformDuration, getSavedMovieCard, };
